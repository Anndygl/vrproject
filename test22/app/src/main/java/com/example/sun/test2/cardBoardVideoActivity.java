...
public class cardBoardVideoActivity extends AppCompatActivity {

    private static final String TAG = cardBoardVideoActivity.class.getSimpleName();
    ...
    private class ActivityEventListener extends VrVideoEventListener  {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    cardBoardVideoActivity.this, "Error loading video: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
    ...
    class VideoLoaderTask extends AsyncTask<Pair<Uri, Options>, Void, Boolean> {
        @Override
        protected Boolean doInBackground(final Pair<Uri, Options>... fileInformation) {
               ...
               final Options options = new Options();
                    ...
                    Thread t=new Thread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                //videoWidgetView.loadVideoFromAsset("congo2.mp4", options);
                                videoWidgetView.loadVideo(Uri.parse("http://192.168.0.107/stream0/stream0.m3u8"),options);
                                //videoWidgetView.loadVideo(Uri.parse("http://mediadelivery.mlbcontrol.net/2016/internal_tests/mlb/vr/congo_v01.mp4"),options);
                                ...
                                Thread t=new Thread(new Runnable() {
                                    ...
                                    public void run() {
                                        videoWidgetView.post(new Runnable() {
                                            ...
                                            public void run() {
                                                Toast
                                                        .makeText(cardBoardVideoActivity.this, "Error opening file. ", Toast.LENGTH_LONG)
                                                        .show();
                                            }
                                        });
                                    }
                    ...
                    final Thread t2 = new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            }catch (IOException e1)
                            {
                                ...
                                Log.e(TAG, "Could not open video: " + e1);
                            }
                        }
                    });
                    t2.start();
